...
$tinybrowser['docroot'] = realpath(dirname(__FILE__).'/../../../').'/';

// ESiBlog : include the global configuration file
include_once($tinybrowser['docroot'].'/secret.php');
...
$tinybrowser['link']['image'] = $context_root.$tinybrowser['path']['image']; // Image links
$tinybrowser['link']['media'] = $context_root.$tinybrowser['path']['media']; // Media links
$tinybrowser['link']['file']  = $context_root.$tinybrowser['path']['file']; // Other file links
